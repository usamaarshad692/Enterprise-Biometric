...
High-scale biometric attendance and identity verification system built using C# (.NET Framework 4.8) with PHP-based image APIs and Microsoft SQL Server.  
Designed for institutional and large user environments requiring secure, reliable, and performance-optimized processing.
...
1. Biometric device captures fingerprint image
...
- Stable LAN / Network connectivity for device communication
...
- PHP (REST APIs)
- Microsoft SQL Server
- Windows 11 Professional (Development/Deployment)
